...
public class KafkaKeyConsumer {
	...
	public void subscribe(ConsumerRecord<String, String> message) throws InterruptedException {
		log.info("key : {}, Partiton : {}, Message : {}", message.key(), message.partition(), message.value());
		Thread.sleep(1000);
	}
